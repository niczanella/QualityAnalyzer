...
if [ -s $DB ]; 
	then 
		...
		cd ..
		spatialite_tool -i -shp files/Limiti_2016_WGS84/Com2016_WGS84/Com2016_WGS84 -d $DB -t adm3 -g geometry -c UTF-8
		spatialite_tool -i -shp files/Limiti_2016_WGS84/CMProv2016_WGS84/CMprov2016_WGS84 -d $DB -t adm2 -g geometry -c UTF-8
		spatialite_tool -i -shp files/Limiti_2016_WGS84/Reg2016_WGS84/Reg_2016_WGS84 -d $DB -t adm1 -g geometry -c UTF-8
		rm files/Limiti_2016_WGS84.zip
		rm -r files/Limiti_2016_WGS84
